...
public class AW_Investimento {
	...
	private void initialize() {
		...
		txtrInvestimento.setEditable(false);
		...
		txtrValorFuturo.setEditable(false);
		...
		txtrTipoInvestimento.setEditable(false);
		...
		btncalc.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				txtvf.setText(df.format(inv.vf));
				txtipo.setText(String.valueOf(inv.tipo));
			}
		});
		btncalc.setFont(new Font("Tahoma", Font.PLAIN, 20));
		btncalc.setBounds(132, 362, 127, 29);
